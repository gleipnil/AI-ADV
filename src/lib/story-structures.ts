...
export const STORY_STRUCTURES: Record<StoryStructureName, BeatDefinition[]> = {
    save_the_cat: [
        ...
        { name: "Debate", description: "The hero doubts the journey.", turnRange: [7, 7], progress: 0.25 },
        { name: "Break into Two", description: "Enter the special world.", turnRange: [8, 8], progress: 0.3 },
        { name: "B Story", description: "Introduction of a relationship character.", turnRange: [9, 10], progress: 0.35 },
        { name: "Fun and Games", description: "The promise of the premise.", turnRange: [11, 14], progress: 0.5 },
        { name: "Midpoint", description: "A major event. False victory/defeat.", turnRange: [15, 15], progress: 0.55 },
        { name: "Bad Guys Close In", description: "The forces of antagonism regroup.", turnRange: [16, 19], progress: 0.7 },
        { name: "All Is Lost", description: "The lowest point.", turnRange: [20, 20], progress: 0.75 },
        { name: "Dark Night of the Soul", description: "Reflection and finding strength.", turnRange: [21, 22], progress: 0.8 },
        { name: "Break into Three", description: "Realization and decision to fight.", turnRange: [23, 23], progress: 0.85 },
        { name: "Finale", description: "The final showdown.", turnRange: [24, 28], progress: 0.95 },
        { name: "Final Image", description: "The aftermath.", turnRange: [29, 30], progress: 1.0 },
    ],
    story_circle: [
